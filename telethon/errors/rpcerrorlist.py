...
class FloodTestPhoneWaitError(FloodError):
    def __init__(self, **kwargs):
        ...
        super(Exception, self).__init__('tunggu {} sec Hedwar sedang Cek Server'.format(self.seconds))


class FloodWaitError(FloodError):
    def __init__(self, **kwargs):
        self.seconds = int(kwargs.get('capture', 0))
        super(Exception, self).__init__('tunggu {} seconds agar required'.format(self.seconds))


class TakeoutInitDelayError(FloodError):
    def __init__(self, **kwargs):
        self.seconds = int(kwargs.get('capture', 0))
        super(Exception, self).__init__('tunggu {} seconds is required before being able to initiate the takeout'.format(self.seconds))
...
class AuthKeyInvalidError(UnauthorizedError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__('Kode Tidak Benar')
...
class BotChannelsNaError(BadRequestError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__("Maaf kamu tidak Diizinkan edit Privatevilage oleh Hedwar")


class BotGroupsBlockedError(BadRequestError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__("Dilarang oleh Hedwar menambah group")


class BotInlineDisabledError(BadRequestError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__("Dilarang oleh Hedwar Menggunakan mode Sannin Inline")
